...
def test_case_0():
    ...
    assert timer_0.last == pytest.approx(0.00021625000226777047, abs=0.01, rel=0.01)
    assert timer_1.last == pytest.approx(0.00021625000226777047, abs=0.01, rel=0.01)
    str_0 = ',(\r[x*&B_2'
...
def test_case_1():
    ...
    assert timer_0.last == pytest.approx(0.00014162499428493902, abs=0.01, rel=0.01)
    assert timer_1.last == pytest.approx(0.00014162499428493902, abs=0.01, rel=0.01)
...
def test_case_3():
    ...
    assert timer_0.last == pytest.approx(0.0002010000025620684, abs=0.01, rel=0.01)
    assert timer_1.last == pytest.approx(0.0002010000025620684, abs=0.01, rel=0.01)
...
def test_case_4():
    ...
    assert timer_1.text == 'Elapsed time: {:0.4f} seconds'
    none_type_0 = timer_1.__exit__()
    assert timer_0.last == pytest.approx(0.00014320800255518407, abs=0.01, rel=0.01)
    assert timer_1.last == pytest.approx(0.00014320800255518407, abs=0.01, rel=0.01)
