...
import pytest
import codetiming_local.codetiming._timer as module_0
...
def test_case_0():
    ...
    assert f'{type(timer_1).__module__}.{type(timer_1).__qualname__}' == 'codetiming_local.codetiming._timer.Timer'
...
def test_case_1():
    ...
    assert float_0 == pytest.approx(0.00025414400079171173, abs=0.01, rel=0.01)
    assert timer_0.last == pytest.approx(0.00025414400079171173, abs=0.01, rel=0.01)
    with pytest.raises(module_0.TimerError):
        timer_0.stop()
